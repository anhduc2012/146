...
function action(mode, type, selection) {
    ...
    if (status == 0) {
	cm.sendYesNo("Ði tàu này và b¢n s³ «i «ªn mØt lîc «Åa lÜn hÛn. ÐÑi vÜi #e150 mesos #n, tôi s³ «ïa b¢n «ªn #bVictoria Island #k. V¬n «¹ là, mØt khi b¢n rßi khÇi nÛi này, b¢n không bao giß có thº quay trä l¢i. B¢n nghÄ sao? B¢n có muÑn «i «ªn «¡o Victoria không?");
    } else if (status == 1) {
	if (cm.haveItem(4031801)) {
	    ...
	    cm.sendNext("Chán nÛi này? Ðây ... H»y cho tôi #e150 mesos #n trïÜc...");
	}
    } else if (status == 2) {
	if (cm.haveItem(4031801)) {
		...
		if (cm.getMeso() < 150) {
		    ...
		    cm.sendNext("Tuy½t vßi! #e150#n mesos «ïæc ch¬p nh±n! Ðïæc rÓi, «ªn Ð¡o Victoria!");
		}
	    } else {
