...
function action(mode, type, selection) {
	...
	if (cm.getJob() == 0) {
		...
		cm.sendNext("V¾ v±y, b¢n quyªt «Ånh trä thành mØt #rCung Thç#k?");
	    } else {
		cm.sendOk("Ðào t¢o nhi¹u hÛn mØt chút và tôi có thº ch¿ cho b¢n cách train cça #rCung Thç#k.")
		cm.dispose();
	    }
	} else {
		...
		if (cm.getQuestStatus(100101) == 2) {
		    cm.sendOk("Ðïæc rÓi, bây giß h»y nói chuy½n vÜi #bRene#k.");
		} else {
	...
	cm.sendNextPrev("Tiªp theo b¢n s³ «ïæc lûa chÎn #rCung Thç#k ho¶c #rNÇ Thç#k.")
    } else if (status == 12) {
