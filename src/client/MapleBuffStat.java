...
public enum MapleBuffStat implements Serializable, Buffstat {
 ...
 //   MAGIC_RESISTANCE(0x40000, 3),
    ...
    INDIE_MAD(0x800, 5, true), // tan cong vat ly
    ...
    ADVANCED_QUIVER (0x4000, 4),
    QUIVER_KARTRIGE (0x8000, 4),
