...
public static byte[] showAndroidEmotion(int cid, byte emo1) {
    ...
    public static byte[] skillEffect2(MapleCharacter from, SkillEffectEntry entry, final Point pos) {
        MaplePacketLittleEndianWriter packet = new MaplePacketLittleEndianWriter();
...
//                mplew.writeInt(Integer.MAX_VALUE);
    ...
    public static byte[] QuiverKartrige(MapleCharacter chr, int mode, int count, boolean counting) {
        MaplePacketLittleEndianWriter packet = new MaplePacketLittleEndianWriter();
        packet.writeShort(SendPacketOpcode.GIVE_BUFF.getValue());
        PacketHelper.writeSingleMask(packet, MapleBuffStat.QUIVER_KARTRIGE);
        int QKSet = 101010;
        if (counting) {
    ...
    public static byte[] giveMagicArrow(MapleCharacter chr) {
        MaplePacketLittleEndianWriter packet = new MaplePacketLittleEndianWriter();
