...
public class HairFaceDump {
    ...
    public static String createStyler(List<Integer> maleHair1, List<Integer> maleHair2, List<Integer> maleHair3, List<Integer> femaleHair1, List<Integer> femaleHair2, List<Integer> femaleHair3, List<Integer> maleFace, List<Integer> femaleFace, List<Integer> hairList, List<Integer> faceList) {
        ...
        addLine(sb, "var v20;");
        addLine(sb, "var v21;");
        addLine(sb, "var hair1;");
        addLine(sb, "var face1;");
        addLine(sb, "var hair2;");
        addLine(sb, "var face2;");
        addLine(sb, "var v24;");
        addLine(sb, "var v25;");
        addLine(sb, "var v26;");
        addLine(sb, "var v27;");
        ...
        addLine(sb, "   gender = cm.getPlayerStat(\"GENDER\");");
        addLine(sb, "   v18 = 0;");
        addLine(sb, "   v19 = " + maleFace.toString() + ";");
        addLine(sb, "   v20 = " + femaleFace.toString() + ";");
        addLine(sb, "   v21 = 0;");
        addLine(sb, "   hair1 = cm.getPlayer().getHair();");
        addLine(sb, "   face1 = cm.getPlayer().getFace();");
        addLine(sb, "   hair2 = cm.getPlayer().getSecondHair();");
        addLine(sb, "   face2 = cm.getPlayer().getSecondFace();");
        addLine(sb, "   v25 = 0;");
        addLine(sb, "   v26 = " + hairList.toString() + ";");
        addLine(sb, "   v27 = " + faceList.toString() + ";");
        addLine(sb, "   if (cm.getPlayer().getJob() == 10112 && beta == 3) { //zero");
        addLine(sb,"cm.sendSimple(\"Time for make-up! Who would you like to edit?\\r\\n\"");
        addLine(sb,"+ \"#L888#Alpha#l\\r\\n#L999#Beta#l\");");
        addLine(sb,"} else {");
        addLine(sb, "   cm.sendSimple(\"Time for make-up!\\r\\n#L0#Skin#l\\r\\n#L1#Haircut#l\" + (gender == 0 ? ((\"\" + v7 != v9 ? \"\\r\\n#L2#Haircut2#l\" : \"\") + (\"\" + v7 != v11 ? \"\\r\\n#L3#Haircut3#l\" : \"\")) : ((\"\" + v8 != v10 ? \"\\r\\n#L2#Haircut2#l\" : \"\") + (\"\" + v8 != v12 ? \"\\r\\n#L3#Haircut3#l\" : \"\"))) + \"\\r\\n#L4#Hair Color#l\\r\\n#L5#Face#l\\r\\n#L6#Eye Color#l\");");
        addLine(sb, "}");
        addLine(sb, "}");
        addLine(sb, "");
        ...
        addLine(sb, "                    break;");
        addLine(sb, "                case 1:");
        addLine(sb, "                    for each(v15 in gender == 0 ? v7 : v8)");
        addLine(sb, "                        if (hairExists(v15))");
        addLine(sb, "                            v2.push(v15);");
        addLine(sb, "                    sendStyle(v2);");
        addLine(sb, "                    break;");
        addLine(sb, "                case 2:");
        addLine(sb, "                    for each(v15 in gender == 0 ? v9 : v10)");
        addLine(sb, "                        if (hairExists(v15))");
        addLine(sb, "                            v2.push(v15);");
        addLine(sb, "                    sendStyle(v2);");
        addLine(sb, "                    break;");
        addLine(sb, "                case 3:");
        addLine(sb, "                    for each(v15 in gender == 0 ? v11 : v12)");
        addLine(sb, "                        if (hairExists(v15))");
        addLine(sb, "                            v2.push(v15);");
        addLine(sb, "                    sendStyle(v2);");
        addLine(sb, "                    break;");
        ...
        addLine(sb, "                        if (hairExists(beta == 1 ? hair2 : hair1 + v18))");
        addLine(sb, "                            v3.push(beta == 1 ? hair2 : hair1 + v18);");
        addLine(sb, "                    sendStyle(v3);");
        addLine(sb, "                    break;");
        addLine(sb, "                case 5:");
        addLine(sb, "                    for each(v15 in gender == 0 ? v19 : v20)");
        ...
        addLine(sb, "                        if (faceExists(face1 + (v21 * 100)))");
        addLine(sb, "                            v5.push(face1 + (v21 * 100));");
        ...
        addLine(sb, "                case 2:");
        addLine(sb, "                case 3:");
        addLine(sb, "                    if (beta = 2) {");
        addLine(sb, "                    cm.setSecondHair(v2[v24]);");
        addLine(sb, "                    } else {");
        ...
        addLine(sb, "                case 4:");
        addLine(sb, "                    if (beta = 2) {");
        addLine(sb, "                    cm.setSecondHair(v3[v24]);");
        addLine(sb, "                    } else {");
        ...
        addLine(sb, "                case 5:");
        addLine(sb, "                    if (beta = 2) {");
        addLine(sb, "                    cm.setSecondHair(v4[v24]);");
        addLine(sb, "                    } else {");
        addLine(sb, "                    cm.setHair(v4[v24]);");
        addLine(sb, "                    }");
        addLine(sb, "                    break;");
        addLine(sb, "                case 6:");
        addLine(sb, "                    if (beta = 2) {");
        addLine(sb, "                    cm.setSecondHair(v5[v24]);");
        addLine(sb, "                    } else {");
        addLine(sb, "                    cm.setHair(v5[v24]);");
        addLine(sb, "                    }");
        addLine(sb, "                    break;");
        addLine(sb, "            }");
        addLine(sb, "            cm.dispose();");
