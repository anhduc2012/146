...
public class ServerConfig {
    ...
    public static final String serverName = "MapleLove";
    public static final String eventMessage = "Chào möng b¢n «ªn vÜi LoveMS!";
    public static final String rankingURL = "http://maplelove.net/?base=main&page=rankings";
    ...
    public static final int EXP_RATE = 1000; //exp rate (only works when fixedRates = true)
    public static final int MESO_RATE = 2; //meso rate (only works when fixedRates = true)
    public static final int DROP_RATE = 1; //drop rate (only works when fixedRates = true)
