...
public class WorldConstants {
    ...
    public static enum WorldOption {
        ...
        Scania(0, 100, 30, 2, (byte) 5, true, true, 20, "Default world!");
        ...
        WorldOption(int world, byte flag, boolean show, int channels) {
            this.world = world;
            this.exp = (ServerConfig.fixedRates ? ServerConfig.EXP_RATE : 1);
            this.meso = (ServerConfig.fixedRates ? ServerConfig.MESO_RATE : 5);
            this.drop = (ServerConfig.fixedRates ? ServerConfig.DROP_RATE : 2);
            this.flag = flag;
            this.show = show;
            this.available = show;
        ...
        WorldOption(int world, int exp, int meso, int drop, byte flag, boolean show, boolean available, int channels) {
            this.world = world;
            this.exp = (ServerConfig.fixedRates ? ServerConfig.EXP_RATE : exp);
            this.meso = (ServerConfig.fixedRates ? ServerConfig.MESO_RATE : meso);
            this.drop = (ServerConfig.fixedRates ? ServerConfig.DROP_RATE : drop);
            this.flag = flag;
            this.show = show;
