...
public enum CSCategory {
    ...
    //CAT1_2(1011000, "Daily Deals", 2, CSFlag.HOT.getValue(), 0),//v148
    //CAT1_3(1010200, "Discounted", 2, CSFlag.NORMAL.getValue(), 0),//v148
    CAT1_2(1010300, "Limited Time Specials", 2, CSFlag.NORMAL.getValue(), 0),
    CAT1_3(1010400, "Limited Quantity", 2, CSFlag.NORMAL.getValue(), 0),
    ...
    CAT6_10(1061000, "Shoes", 3, CSFlag.NORMAL.getValue(), 0),
    CAT6_11(1061100, "Glove", 3, CSFlag.NORMAL.getValue(), 0),
    CAT6_12(1061200, "Ring", 2, CSFlag.NORMAL.getValue(), 0),
    CAT6_12_1(1061201, "Stats", 3, CSFlag.NORMAL.getValue(), 0),
    CAT6_12_2(1061202, "Friendship", 3, CSFlag.NORMAL.getValue(), 0),
    CAT6_12_3(1061203, "Label", 3, CSFlag.NORMAL.getValue(), 0),
    CAT6_12_4(1061204, "Quote", 3, CSFlag.NORMAL.getValue(), 0),
    CAT6_12_5(1061206, "Solo", 3, CSFlag.NORMAL.getValue(), 0),
    CAT6_13(1061300, "Cape", 2, CSFlag.NORMAL.getValue(), 0),
    CAT6_14(1061500, "Packages", 2, CSFlag.NORMAL.getValue(), 0),
    CAT6_15(1061600, "Transparent", 2, CSFlag.NORMAL.getValue(), 0),
