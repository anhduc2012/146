...
public class PartyHandler {
        ...
        if ((c.getPlayer().getParty() == null) && (c.getPlayer().getQuestNoAdd(MapleQuest.getInstance(122901)) == null)) {
            ...
            if (party != null) {
                if (party.getExpeditionId() > 0) {
                    c.getPlayer().dropMessage(5, "B¢n không «ïæc thûc hi½n ho¢t «Øng nhóm khi «ang «Øt kích.");
                    return;
                }
                ...
                c.getPlayer().dropMessage(5, "Nhóm b¢n «ang cÑ g¤ng tham gia không tÓn t¢i");
            }
        } else {
            c.getPlayer().dropMessage(5, "B¢n không thº tham gia nhóm khi b¢n «» ä trong mØt nhóm");
        }
    }
        ...
        switch (operation) {
            case 1:
                if (party == null) {
                    ...
                    if ((partyplayer.equals(party.getLeader())) && (party.getMembers().size() == 1)) {
                        ...
                        c.getPlayer().dropMessage(5, "B¢n không thº t¢o nhóm khi b¢n «ang ä trong nhóm");
                    }
                }
                break;
            ...
            case 3:
                ...
                if (party == null) {
                    ...
                    if (party != null) {
                        ...
                        c.getPlayer().dropMessage(5, "Bøa ti½c b¢n «ang cÑ g¤ng tham gia không tÓn t¢i");
                    }
                } else {
                    c.getPlayer().dropMessage(5, "B¢n không thº tham gia nhóm khi b¢n «ang ä trong nhóm");
                }
                break;
            case 4:
                if (party == null) {
                ...
                if (theCh > 0) {
                    ...
                    if ((invited != null) && (invited.getParty() == null) && (invited.getQuestNoAdd(MapleQuest.getInstance(122901)) == null)) {
                        ...
                        c.getPlayer().dropMessage(6, "Ngïßi chÛi «» có nhóm.");
                    }
                } else {
            ...
            case 66://was 7
                ...
                if ((cfrom != null) && (cfrom.getQuestNoAdd(MapleQuest.getInstance(122900)) == null)) {
                    ...
                    c.getPlayer().dropMessage(5, "Ngïßi chÛi không tÓn t¢i ho¶c không «Óng ü.");
                }
                break;
            case 8:
                if (slea.readByte() > 0) {
    ...
    public static void MemberSearch(LittleEndianAccessor slea, MapleClient c) {
        if ((c.getPlayer().isInBlockedMap()) || (FieldLimitType.VipRock.check(c.getPlayer().getMap().getFieldLimit()))) {
            c.getPlayer().dropMessage(5, "B¢n không thº thûc hi½n t¾m kiªm bên t¢i «ây.");
            return;
        }
        ...
        switch (mode) {
            ...
            case 159:
                ...
                if ((c.getPlayer().getParty() == null) && (World.Party.searchParty(pst).size() < 10)) {
                    ...
                    c.getPlayer().dropMessage(1, "Không thº t¢o nhóm.H»y rßi khÇi nhóm.");
                }
                break;
            case -103:
            case -95:
