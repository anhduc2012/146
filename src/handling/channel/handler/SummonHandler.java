...
public static final void MoveDragon(final LittleEndianAccessor slea, final MapleCharacter chr) {//MIXTAMAL6 +Mally
    ...
    public static void SummonAttack(final LittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
        ...
        if (summon.getSkill() / 1000000 != 35 && summon.getSkill() != 33101008 && sse == null) {
            chr.dropMessage(5, "L×i khi x÷ lü t¬n công.");
            return;
        }
        ...
        if (sse != null && numAttacked > sse.mobCount) {
            chr.dropMessage(5, "C¡nh báo: T¬n công nhi¹u quái v±t hÛn summon có thº làm");
