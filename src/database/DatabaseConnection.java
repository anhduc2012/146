 ...
 *
 *  Frz (original method)
 *  BlackRabbit (explaining the "too many connections" problem, and showing an example to fix it)
 *  Novak (Implementing BlackRabbit's fix in this source's connection)
 */
    ...
    private static class ThreadLocalConnection extends ThreadLocal<Connection> {
        ...
        protected Connection initialValue() {
            try {
                ...
                return DriverManager.getConnection("jdbc:mysql://"+ServerConstants.URL +":" + ServerConstants.SQL_PORT + "/" + ServerConstants.SQL_DATABASE + "?autoReconnect=true", ServerConstants.SQL_USER, ServerConstants.SQL_PASSWORD);
