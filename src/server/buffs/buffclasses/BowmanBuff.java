    ...
    public void handleBuff(MapleStatEffect eff, int skill) {
        switch (skill) {
            ...
            case 3121016: //Enchanted Quiver
                eff.statups.put(MapleBuffStat.ADVANCED_QUIVER, eff.info.get(MapleStatInfo.w));
                break;
            ...
            //case 3211012: //Reckless Hunt: Crossbow
                ...
                break;
            case 3211012: //Reckless Hunt: Crossbow
                //eff.statups.put(MapleBuffStat.CRIT_DAMAGE, eff.info.get(MapleStatInfo.z)); //Crit Damage?
                eff.statups.put(MapleBuffStat.CRITICAL_RATE, eff.info.get(MapleStatInfo.x));
                break;
            default:
