           ...
           for (int i = 0; true; i++) { // TODO: Check and reprint all available values again..doing like below is a ridiculous way
            ...
            switch (mid) {
                ...
                case 9300776:
                    ...
                    break;
                case 9300777:
                    stats.setHp(750000000000L);
                    break;
                case 9300028:
                    stats.setHp(900000000000L);
                    break;
                case 8300006:
                    stats.setHp(1050000000000L);
                    break;
                case 6160003:
                    stats.setHp(1200000000000L);
                    break;
                case 8800400:
                    stats.setHp(1350000000000L);
                    break;
                case 8900100:
                    stats.setHp(1500000000000L);
                    break;
                case 8900002:
                    stats.setHp(1650000000000L);
                    break;
                case 8900001:
                    stats.setHp(1800000000000L);
                    break;
                case 8920000:
                    stats.setHp(1950000000000L);
                    break;
