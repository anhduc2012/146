             ...
             if ((nEquip.getStr() > 0) || (Randomizer.nextInt(50) == 1)) {
              ...
              if ((nEquip.getMp() > 0) || (Randomizer.nextInt(5) == 1)) {
                nEquip.setMp((short)(nEquip.getMp() + Randomizer.nextInt(5)));
                            ...
                            if (nEquip.getState() <= 17 && (scrollId.getItemId() / 100 == 20497 && scrollId.getItemId() < 2049750)) {
                                final int chanc = (scrollId.getItemId() == 2049701 ? 80 : 100) + added; // 2049701
                                if (Randomizer.nextInt(100) > chanc) {
                                    return null; //destroyed, nib
                                }
                                nEquip.renewPotential(2, 0, (short) 0, false);
                            }else if (nEquip.getState() <= 17 && (scrollId.getItemId() / 100 == 20497 && scrollId.getItemId() >= 2049750)) {
                                final int chanc = (scrollId.getItemId() == 2049750 ? 80 : 100) + added; // 2049750
                                if (Randomizer.nextInt(100) > chanc) {
                                    return null; //destroyed, nib
                                }
                                nEquip.renewPotential(3, 0, (short) 0, false);
